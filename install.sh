...
echo ""
echo "💡 主な機能："
echo "   - novel init <project-name>    # 新規プロジェクト作成"
echo "   - novel find-context           # キャラクター・エピソード検索"
echo "   - novel weave                  # コンテキストウィーバー"
echo "   - novel style                  # 文体スタイル管理（新機能）"
echo "   - novel dump episodes          # エピソード情報生成"